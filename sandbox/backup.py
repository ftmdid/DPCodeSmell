        ...
        for commit in commitsList:
            for each in similiarClosedBugIssuesList:
                if commit[2]==each[2]: # the author of the change log message has been assigned to bug
                    if each[1] in commit[8]: # the short description of bug report in issue tracting system is contained in change log message
...
#subject="Fixed bug 537484: .class file is missing and your code should also have some defects in it."
#analysis.isBugNumber(subject)
