...
class InstallationCount(BaseCount):
    ...
    def __unicode__(self):
        # type: () -> text_type
        return "<InstallationCount: %s %s>" % (self.property, self.value)
...
class RealmCount(BaseCount):
    ...
    def __unicode__(self):
        # type: () -> text_type
        return "<RealmCount: %s %s %s>" % (self.realm, self.property, self.value)
...
class UserCount(BaseCount):
    ...
    def __unicode__(self):
        # type: () -> text_type
        return "<UserCount: %s %s %s>" % (self.user, self.property, self.value)
...
class StreamCount(BaseCount):
    ...
    def __unicode__(self):
        # type: () -> text_type
        return "<StreamCount: %s %s %s %s>" % (self.stream, self.property, self.value, self.id)