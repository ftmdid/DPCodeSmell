...
class UserProfile(AbstractBaseUser, PermissionsMixin):
    ...
    rate_limits = models.CharField(default="", max_length=100)  # type: str # comma-separated list of range:max pairs
    ...
    alert_words = models.TextField(default='[]')  # type: str # json-serialized list of strings
