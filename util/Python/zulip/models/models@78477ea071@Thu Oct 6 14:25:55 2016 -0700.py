...
class InstallationCount(BaseCount):
    ...
    def __unicode__(self):
        # type: () -> text_type
        return "<InstallationCount: %s %s %s>" % (self.property, self.value, self.id)
...
class RealmCount(BaseCount):
    ...
    def __unicode__(self):
        # type: () -> text_type
        return "<RealmCount: %s %s %s %s>" % (self.realm, self.property, self.value, self.id)
...
class UserCount(BaseCount):
    ...
    def __unicode__(self):
        # type: () -> text_type
        return "<UserCount: %s %s %s %s>" % (self.user, self.property, self.value, self.id)
...
class HuddleCount(BaseCount):
    ...
    def __unicode__(self):
        # type: () -> text_type
        return "<HuddleCount: %s %s %s %s>" % (self.huddle, self.property, self.value, self.id)