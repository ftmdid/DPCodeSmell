...
class Realm(ModelReprMixin, models.Model):
    ...
    default_language = models.CharField(default='en', max_length=MAX_LANGUAGE_ID_LENGTH) # type: text_type
...
class UserProfile(ModelReprMixin, AbstractBaseUser, PermissionsMixin):
    ...
    # completed.
    onboarding_steps = models.TextField(default='[]') # type: text_type

    invites_granted = models.IntegerField(default=0) # type: int
    invites_used = models.IntegerField(default=0) # type: int

    alert_words = models.TextField(default='[]') # type: text_type # json-serialized list of strings

    # Contains serialized JSON of the form:
    # [["social", "mit"], ["devel", "ios"]]
    muted_topics = models.TextField(default='[]') # type: text_type
