...
class Realm(models.Model):
    ...
    video_chat_provider = models.CharField(default="Jitsi", max_length=MAX_VIDEO_CHAT_PROVIDER_LENGTH)
...
def get_active_realm_emoji_uncached(realm: Realm) -> Dict[str, Dict[str, Any]]:
    ...
    d = {}
    for emoji_id, emoji_dict in list(realm_emojis.items()):
...
class Stream(models.Model):
    ...
    description = models.CharField(max_length=MAX_DESCRIPTION_LENGTH, default='')  # type: Text
...
class UserPresence(models.Model):
    ...
    def get_status_dicts_for_rows(presence_rows: List[Dict[str, Any]],
        ...
        for email, info_rows in list(info_row_dct.items()):
...
class CustomProfileField(models.Model):
    ...
    FIELD_TYPE_DATA = [
        ...
        (LONG_TEXT, 'Long Text', check_long_string, str),
        (DATE, 'Date', check_date, str),
        (URL, 'URL', check_url, str),
    ]  # type: FieldTypeData
