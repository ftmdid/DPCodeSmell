...
for setting_name, setting_val in list(DEFAULT_SETTINGS.items()):
...
ALLOWED_HOSTS += list(REALM_HOSTS.values())
...
for idp_name, idp_dict in list(SOCIAL_AUTH_SAML_ENABLED_IDPS.items()):
    if DEVELOPMENT:
