...
SIGNUP_STRING = 'Your e-mail does not match any existing open organization. ' + \
                'Use a different e-mail address, or contact %s with questions.' % (settings.ZULIP_ADMINISTRATOR,)
if settings.SHOW_OSS_ANNOUNCEMENT:
    SIGNUP_STRING = 'Your e-mail does not match any existing organization. <br />' + \
                    "The zulip.com service is not taking new customer teams. <br /> " + \
                    "<a href=\"https://blogs.dropbox.com/tech/2015/09/open-sourcing-zulip-a-dropbox-hack-week-project/\">" + \
                    "Zulip is open source</a>, so you can install your own Zulip server " + \
                    "by following the instructions on <a href=\"https://www.zulip.org\">www.zulip.org</a>!"
MIT_VALIDATION_ERROR = 'That user does not exist at MIT or is a ' + \
                       ...
                       '<a href="mailto:"' + settings.ZULIP_ADMINISTRATOR + '">contact us</a>.'
...
class OurAuthenticationForm(AuthenticationForm):
    def clean_username(self):
        ...
        if user_profile.realm.deactivated:
            error_msg = """Sorry for the trouble, but %s has been deactivated.
