...
SIGNUP_STRING = 'Use a different e-mail address, or contact %s with questions.'%(settings.ZULIP_ADMINISTRATOR,)
...
class HomepageForm(forms.Form):
    ...
    def clean_email(self):
        ...
        raise ValidationError(mark_safe(
                'Your e-mail does not match any existing open organization. ' \
                    + SIGNUP_STRING))
