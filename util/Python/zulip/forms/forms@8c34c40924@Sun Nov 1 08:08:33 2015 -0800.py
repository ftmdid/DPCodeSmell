...
if settings.ZULIP_COM:
    SIGNUP_STRING = 'Your e-mail does not match any existing organization. <br />' + \
                    ...
                    "<a href=\"https://blogs.dropbox.com/tech/2015/09/open-sourcing-zulip-a-dropbox-hack-week-project/\">Zulip is open source</a>, so you can install your own Zulip server " + \
