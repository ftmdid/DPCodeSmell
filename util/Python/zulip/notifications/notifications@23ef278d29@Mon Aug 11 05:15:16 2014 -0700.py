...
def handle_missedmessage_emails(user_profile_id, missed_email_events):
    ...
    if user_profile.realm.domain == 'zulip.com':
        for msg_list in list(messages_by_recipient_subject.values()):
            ...
            do_send_missedmessage_events_reply_in_zulip(user_profile, list(unique_messages.values()))
    else:
        all_messages = [
            msg
            for msg_list in list(messages_by_recipient_subject.values())
        ...
        do_send_missedmessage_events(user_profile, list(unique_messages.values()))
