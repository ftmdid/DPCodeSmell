...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('zephyr_userprofile', 'onboarding_steps',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('zephyr_userprofile', 'onboarding_steps')
    ...
    models = {
        ...
        'zephyr.userprofile': {
            ...
            'bot_owner': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['zephyr.UserProfile']", 'null': 'True', 'on_delete': 'models.SET_NULL'}),
