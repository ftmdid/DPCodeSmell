...
templates = {
    'userstory': {
        ...
        'changed_assigned_to': ':busts_in_silhouette: %(user)s reassigned user story **%(subject)s** from %(old)s to %(new)s.',
        ...
        'changed_milestone': ':calendar: %(user)s changed sprint of user story **%(subject)s** from %(old)s to %(new)s.',
        'changed_status': ':chart_with_upwards_trend: %(user)s changed status of user story **%(subject)s** from %(old)s to %(new)s.',
        ...
        'description': ':notebook: %(user)s updated description of user story **%(subject)s**.',
    ...
    'milestone': {
        ...
        'estimated_start': ':calendar: %(user)s changed estimated start of sprint **%(subject)s** from %(old)s to %(new)s.',
        'estimated_finish': ':calendar: %(user)s changed estimated finish of sprint **%(subject)s** from %(old)s to %(new)s.',
    ...
    'task': {
        ...
        'changed_assigned_to': ':busts_in_silhouette: %(user)s reassigned task **%(subject)s** from %(old)s to %(new)s.',
        ...
        'changed_milestone': ':calendar: %(user)s changed sprint of task **%(subject)s** from %(old)s to %(new)s.',
        'changed_status': ':chart_with_upwards_trend: %(user)s changed status of task **%(subject)s** from %(old)s to %(new)s.',
        'renamed': ':notebook: %(user)s renamed task %(old)s to **%(new)s**.',
        'description': ':notebook: %(user)s updated description of task **%(subject)s**.',
    ...
    'issue': {
        ...
        'changed_assigned_to': ':busts_in_silhouette: %(user)s reassigned issue **%(subject)s** from %(old)s to %(new)s.',
        'changed_priority': ':rocket: %(user)s changed priority of issue **%(subject)s** from %(old)s to %(new)s.',
        'changed_severity': ':warning: %(user)s changed severity of issue **%(subject)s** from %(old)s to %(new)s.',
        'changed_status': ':chart_with_upwards_trend: %(user)s changed status of issue **%(subject)s** from %(old)s to %(new)s.',
        ...
        'description': ':notebook: %(user)s updated description of issue **%(subject)s**.',
