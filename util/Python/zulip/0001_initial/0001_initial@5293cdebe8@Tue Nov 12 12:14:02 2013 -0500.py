...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('zilencer_deployment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('is_active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('api_key', self.gf('django.db.models.fields.CharField')(max_length=32, null=True)),
        ))
        db.send_create_signal('zilencer', ['Deployment'])

        # Adding M2M table for field realms on 'Deployment'
        db.create_table('zilencer_deployment_realms', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('deployment', models.ForeignKey(orm['zilencer.deployment'], null=False)),
            ('realm', models.ForeignKey(orm['zerver.realm'], null=False))
        ))
        db.create_unique('zilencer_deployment_realms', ['deployment_id', 'realm_id'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('zilencer_deployment')
    ...
    models = {
        'zerver.realm': {
            ...
            'notifications_stream': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': "orm['zerver.Stream']"}),
        ...
        'zerver.stream': {
            ...
            'realm': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['zerver.Realm']"})
        },
        'zilencer.deployment': {
            ...
            'realms': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'_deployments'", 'symmetrical': 'False', 'to': "orm['zerver.Realm']"})
        }
    }
