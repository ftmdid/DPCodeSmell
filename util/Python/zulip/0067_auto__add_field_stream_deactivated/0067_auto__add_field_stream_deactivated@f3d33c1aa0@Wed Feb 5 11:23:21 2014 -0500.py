...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('zerver_stream', 'deactivated',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('zerver_stream', 'deactivated')
    ...
    models = {
        ...
        'zerver.defaultstream': {
            ...
            'stream': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['zerver.Stream']"})
        },
        'zerver.huddle': {
        ...
        'zerver.message': {
            ...
            'recipient': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['zerver.Recipient']"}),
            ...
            'sender': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['zerver.UserProfile']"}),
            'sending_client': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['zerver.Client']"}),
        ...
        'zerver.preregistrationuser': {
            'Meta': {'object_name': 'PreregistrationUser'},
            'email': ('django.db.models.fields.EmailField', [], {'max_length': '75'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invited_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'realm': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['zerver.Realm']", 'null': 'True'}),
            'referred_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['zerver.UserProfile']", 'null': 'True'}),
            'status': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'streams': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['zerver.Stream']", 'null': 'True', 'symmetrical': 'False'})
        },
        'zerver.pushdevicetoken': {
        ...
        'zerver.referral': {
            ...
            'user_profile': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['zerver.UserProfile']"})
        },
        'zerver.scheduledjob': {
        ...
        'zerver.streamcolor': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'subscription': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['zerver.Subscription']"})
        },
        'zerver.subscription': {
        ...
        'zerver.useractivity': {
            ...
            'client': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['zerver.Client']"}),
        ...
        'zerver.usermessage': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'message': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['zerver.Message']"}),
            'user_profile': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['zerver.UserProfile']"})
        },
        'zerver.userpresence': {
        ...
        'zerver.userprofile': {
            ...
            'bot_owner': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['zerver.UserProfile']", 'null': 'True', 'on_delete': 'models.SET_NULL'}),
