    ...
    for event in events:
        if event['type'] == "message":
            ...
            if event['op'] == "add":
                ...
                state['unsubscribed'] = list(itertools.filterfalse(was_added, state['unsubscribed']))
                ...
                state['subscriptions'] = list(itertools.filterfalse(was_removed, state['subscriptions']))
