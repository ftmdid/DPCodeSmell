...
# This class is only here for backward compatibility and to avoid circular
# imports. It should be removed in 0.15, when the CCA class of this module is
# removed, and be placed in the cca module.
class _CCA(_PLS):
...
class CCA(_CCA):
    @deprecated("The CCA class has been moved to the cca module. This "
                "class will be removed in 0.15.")
    def __init__(self, n_components=2, scale=True,
                 max_iter=500, tol=1e-06, copy=True):
