...
class LeaveOneOut(BaseCrossValidator):
    ...
    def _iter_test_indices(self, X, y=None, groups=None):
        return list(range(_num_samples(X)))
...
class LeavePOut(BaseCrossValidator):
    ...
    def _iter_test_indices(self, X, y=None, groups=None):
        for combination in combinations(list(range(_num_samples(X))), self.p):
...
class TimeSeriesSplit(_BaseKFold):
    ...
    def split(self, X, y=None, groups=None):
        ...
        test_starts = list(range(test_size + n_samples % n_folds,
                            n_samples, test_size))
...
class LeavePGroupsOut(BaseCrossValidator):
    ...
    def _iter_test_masks(self, X, y, groups):
        ...
        combi = combinations(list(range(len(unique_groups))), self.n_groups)
...
def _build_repr(self):
    ...
    if init is object.__init__:
        ...
        args = sorted([p.name for p in list(init_signature.parameters.values())
