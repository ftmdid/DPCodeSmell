...
class LogisticRegression(BaseEstimator, LinearClassifierMixin,
    ...
    def fit(self, X, y, sample_weight=None):
        ...
        fold_coefs_, _, n_iter_ = list(zip(*fold_coefs_))
...
class LogisticRegressionCV(LogisticRegression, BaseEstimator,
    ...
    def fit(self, X, y, sample_weight=None):
        ...
        if self.class_weight in ("auto", "balanced"):
            ...
            class_weight = dict(list(zip(classes, class_weight)))
        else:
        ...
        if self.multi_class == 'multinomial':
            multi_coefs_paths, Cs, multi_scores, n_iter_ = list(zip(*fold_coefs_))
            ...
            coefs_paths, Cs, scores, n_iter_ = list(zip(*fold_coefs_))
            self.Cs_ = Cs[0]
        ...
        self.coefs_paths_ = dict(list(zip(labels, coefs_paths)))
        scores = np.reshape(scores, (n_classes, len(folds), -1))
        self.scores_ = dict(list(zip(labels, scores)))
