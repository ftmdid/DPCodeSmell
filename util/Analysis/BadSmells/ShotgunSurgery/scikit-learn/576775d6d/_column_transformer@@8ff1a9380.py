...
class ColumnTransformer(TransformerMixin, _BaseComposition):
    ...
    def _validate_transformers(self):
        ...
        names, transformers, _ = list(zip(*self.transformers))
    ...
    def _sk_visual_block_(self):
        ...
        names, transformers, name_details = list(zip(*transformers))
...
def _get_transformer_list(estimators):
    ...
    """
    transformers, columns = list(zip(*estimators))
    names, _ = list(zip(*_name_estimators(transformers)))
