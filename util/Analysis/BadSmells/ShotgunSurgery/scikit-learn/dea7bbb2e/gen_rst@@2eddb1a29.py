        ...
        if not os.path.exists(first_image_file) or \
           os.stat(first_image_file).st_mtime <= os.stat(src_file).st_mtime:
            ...
            try:
                ...
                my_globals = {'pl': plt}
                exec(compile(open(os.path.basename(src_file), "rb").read(), os.path.basename(src_file), 'exec'), my_globals)
                ...
                example_code_obj = {}
                for var_name, var in list(my_globals.items()):
...
def embed_code_links(app, exception):
    ...
    try:
        if exception is not None:
            return
        # print 'Embedding docume ntation hyperlinks in examples..'
# 
                    ...
                    if len(str_repl) > 0:
                        ...
                        with open(full_fname, 'wb') as fid:
                            for line in lines_in:
                                ...
                                for name, link in list(str_repl.items()):
