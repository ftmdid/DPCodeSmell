...
class Kernel(six.with_metaclass(ABCMeta)):
    ...
    def get_params(self, deep=True):
        ...
        args, varargs = [], []
        for parameter in list(init_sign.parameters.values()):
...
class KernelOperator(Kernel):
    ...
    def get_params(self, deep=True):
        ...
        if deep:
            deep_items = list(self.k1.get_params().items())
            params.update(('k1__' + k, val) for k, val in deep_items)
            deep_items = list(self.k2.get_params().items())
...
class Exponentiation(Kernel):
    ...
    def get_params(self, deep=True):
        ...
        if deep:
            deep_items = list(self.kernel.get_params().items())
